...
def select_hot_strips(dqm_path, file_path, run_number=359691, fill=8754, run_era="Run2022E", threshold_ratio=0.0005):
    file_name = glob(f"{file_path}/histo_{fill}_{run_number}-2024.root")[0]
    try:
    ...
    nEvents = gem_bkg['events'].values()[1]
